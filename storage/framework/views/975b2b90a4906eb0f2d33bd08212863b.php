...
<body class="app">   	
  ...
  <path fill-rule="evenodd" d="M8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z"/>
			            ...
			            <div class="app-utility-item app-user-dropdown dropdown">
				            ...
				            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
								<li><a class="dropdown-item" href="<?php echo e(route('account')); ?>">Account</a></li>
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
		  ...
		  <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
					    ...
					    <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					         <a class="nav-link <?php echo e(request()->routeIs('doc.index') ? 'active' : ''); ?>" href="<?php echo e(route('doc.index')); ?>">
						        <span class="nav-icon">
  ...
  <path fill-rule="evenodd" d="M13.81 4H2.19a1 1 0 0 0-.996 1.09l.637 7a1 1 0 0 0 .995.91h10.348a1 1 0 0 0 .995-.91l.637-7A1 1 0 0 0 13.81 4zM2.19 3A2 2 0 0 0 .198 5.181l.637 7A2 2 0 0 0 2.826 14h10.348a2 2 0 0 0 1.991-1.819l.637-7A2 2 0 0 0 13.81 3H2.19z"/>
					    ...
					    <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link <?php echo e(request()->routeIs('payment.index') ? 'active' : ''); ?>" href="<?php echo e(route('payment.index')); ?>">
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
    ...
    <?php
        ...
        $settingsActive = request()->routeIs('user.*') || request()->routeIs('course.*');
    ?>
    ...
    <div id="submenu-2"
        ...
        <ul class="submenu-list list-unstyled">
            ...
            <li class="submenu-item">
                <a class="submenu-link <?php echo e(request()->routeIs('course.*') ? 'active' : ''); ?>" href="<?php echo e(route('course.index')); ?>">
                    Courses/Sections
                </a>
            </li>
        </ul>
						...
						<li class="nav-item">
    <a class="nav-link <?php echo e(request()->routeIs('agenda.index') ? 'active' : ''); ?>" href="<?php echo e(route('agenda.index')); ?>">
        <span class="nav-icon">
...
<li class="nav-item">
    <a class="nav-link <?php echo e(request()->routeIs('student.index') ? 'active' : ''); ?>" href="<?php echo e(route('student.index')); ?>">
        <span class="nav-icon">
    ...
    <!-- BEGIN: Footer-- remove comment if footer is fixed
    <footer class="footer footer-static footer-light navbar-border navbar-shadow" style ="background-color:black;">
        <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2023 <a class="text-bold-800" href="#" target="_blank">Buset Manji Gang</a></span><span class="float-md-right d-none d-lg-block">We make things mas madali!<span id="scroll-top"></span></span></p>
    </footer>
    -- END: Footer-->

	
    <!-- BEGIN: Vendor JS-->
    <script src="<?php echo e(asset('app-assets/vendors/js/material-vendors.min.js')); ?>"></script>
    <!-- BEGIN Vendor JS-->
    ...
    <script src="<?php echo e(asset('app-assets/js/scripts/tables/material-datatable.js')); ?>"></script>
    <!-- END: Page JS-->
