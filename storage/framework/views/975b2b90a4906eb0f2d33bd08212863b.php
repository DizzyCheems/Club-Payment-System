...
<body class="app">   	
  ...
  <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
			            ...
			            <div class="app-utility-item app-user-dropdown dropdown">
				            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src="<?php echo e(asset('assets/images/user.jpg')); ?>" alt="user profile"></a>
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
					        ...
					        <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
								...
								<li class="submenu-item"><a class="submenu-link" href="<?php echo e(route('user.index')); ?>">Users</a></li>
							  	<li class="submenu-item"><a class="submenu-link" href="<?php echo e(route('course.index')); ?>">Courses/Sections</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
