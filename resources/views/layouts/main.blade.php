...
<body class="app">   	
  ...
  <path fill-rule="evenodd" d="M8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z"/>
			            ...
			            <div class="app-utility-item app-user-dropdown dropdown">
				            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src="{{asset('assets/images/no_profile.jpg')}}" alt="user profile"></a>
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="{{route('dashboard')}}"><img class="logo-icon me-2" src="{{asset('assets/images/logo.jpg')}}" alt="logo"><span class="logo-text">CSD System</span></a>
		  ...
		  <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
					    ...
					    <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					         <a class="nav-link {{ request()->routeIs('doc.index') ? 'active' : '' }}" href="{{ route('doc.index') }}">
						        <span class="nav-icon">
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
    ...
    <a class="nav-link submenu-toggle {{ $settingsActive ? 'active' : '' }}" href="#"
    ...
    <div id="submenu-2"
         class="collapse submenu submenu-2 {{ $settingsActive ? 'show' : '' }}"
         data-bs-parent="#menu-accordion">
        <ul class="submenu-list list-unstyled">
            <li class="submenu-item">
                <a class="submenu-link {{ request()->routeIs('user.*') ? 'active' : '' }}" href="{{ route('user.index') }}">
                    Users
                </a>
            </li>
            <li class="submenu-item">
                <a class="submenu-link {{ request()->routeIs('course.*') ? 'active' : '' }}" href="{{ route('course.index') }}">
                    Courses/Sections
                </a>
            </li>
        </ul>
