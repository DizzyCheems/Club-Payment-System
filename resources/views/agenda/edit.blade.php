    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <h1 class="app-page-title">Update Agenda Info</h1>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                             <h5>Students Paid<span class="required"></span></h5>
                                <div class="controls">
                                    <input type="number" name="students_paid" class="form-control mb-1" required data-validation-required-message="• This field is required"  value="{{$agendas['students_paid']}}">
