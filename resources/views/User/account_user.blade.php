                    ...
                    <div class="app-card-body p-3 p-lg-4">
                        ...
                        <div class="row gx-5 gy-3">
                            <div class="col-12 col-lg-8">
                                ...
                                <div class="mt-4">
                                    <a href="{{ route('user.account.edit') }}" class="btn app-btn-primary">Edit Account</a>
                                    <a href="{{ route('dashboard.user') }}" class="btn app-btn-secondary ms-2">Back to Dashboard</a>
                                </div>
                            </div><!--//col-->
