    ...
    <div class="app-wrapper">
        ...
        <div class="container-xl">
                 <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert" >
				    <div class="inner">
                       <h1 class="app-page-title">Edit Student Details</h1>
				    <div class="inner">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                             <h5>Student Name<span class="required"></span></h5>
                                <div class="controls">
                                    <input type="text" name="name" class="form-control mb-1" value="{{$students['name']}}" required data-validation-required-message="• This field is required">
                                </div>
                         </div>
                         ...
                         <div class="form-group">
                             <h5>FB Account<span class="required"></span></h5>
                                <div class="controls">
                                    <input type="text" name="social_acc" class="form-control mb-1" value="{{$students['social_acc']}}" required data-validation-required-message="• This field is required">
